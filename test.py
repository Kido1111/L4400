...
os.system('clear')
print("\033[1;96m                    script by.KID")
print("")
print("\033[1;96m                    Spam Sms v.2")
print("")
print("\033[1;96m                   {✓} FB:Atitep Setthamas")
phone = input("\033[1;95m [K]Number : ")
num=int(input("\033[1;95m [K]Many : "))
